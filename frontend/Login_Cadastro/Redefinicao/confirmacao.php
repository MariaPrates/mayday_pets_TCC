...
<html lang="en">
    ...
    <body class="BackgroundTheme">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="./index.php?pag=redefinir_senha">
        ...
        <div class="container-fluid ">
            <div class="row">
                ...
                <div class="col-5 WidthCol-5">
                    ...
                    <form id="form_confirmacao_red" action="#" method="POST" name="form_confirmacao_red">

                        <div class="MarginTopIndexLogo BackgroundThemeE1B1B8 p-3 rounded">
                            <input type="hidden" name="grupo" value="usuarios">
                            <input type="hidden" name="acao" value="redefinicao_cod">
                            ...
                            <button class="btn BackgroundTheme ButtonRadius p-2 mt-3" type="submit" id="corfirmar_codigo">
                                <h5 class="d-inline text-white">Confirmar</h5> 
                            </button>

                            <a href="./index.php?pag=index" class="btn BackgroundTheme ButtonRadius p-2 mt-3 ms-2" type="submit" id="FazerLogin">
        ...
        <script src="./frontend/JS/confirmacao/confirmacao_redefinicao.js"></script>
